import { FullBuildingModel, OpaqueSurfaceInput, OpeningInput, EnergyScenarioInput } from '../types/xmlKenak';
 ...
 */
export function generateOptimalScenarios(model: FullBuildingModel): EnergyScenarioInput[] {
  const isPre1979 = model.ageCategory === 'PRE_1979' || model.yearBuilt < 1980;

  const scenarios: EnergyScenarioInput[] = [
    {
      id: 'scen-auto-1',
